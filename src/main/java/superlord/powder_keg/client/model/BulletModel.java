package superlord.powder_keg.client.model;
...
public class BulletModel<T extends Entity> extends EntityModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(PowderKeg.MOD_ID, "bullet"), "main");
