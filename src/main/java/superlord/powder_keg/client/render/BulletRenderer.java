package superlord.powder_keg.client.render;
...
public class BulletRenderer extends EntityRenderer<Bullet> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(PowderKeg.MOD_ID, "textures/entity/bullet.png");

    public BulletRenderer(EntityRendererProvider.Context ctx) {
        super(ctx);
    }
    
    public void render(Bullet p_113839_, float p_113840_, float p_113841_, PoseStack p_113842_, MultiBufferSource p_113843_, int p_113844_) {
    	p_113842_.pushPose();
        ...
        for(int j = 0; j < 4; ++j) {
           p_113842_.mulPose(Vector3f.XP.rotationDegrees(90.0F));
           this.vertex(matrix4f, matrix3f, vertexconsumer, -4, -2, 0, 0.0F, 0.0F, 0, 1, 0, p_113844_);
           this.vertex(matrix4f, matrix3f, vertexconsumer, 4, -2, 0, 0.5F, 0.0F, 0, 1, 0, p_113844_);
           this.vertex(matrix4f, matrix3f, vertexconsumer, 4, 2, 0, 0.5F, 0.15625F, 0, 1, 0, p_113844_);
           this.vertex(matrix4f, matrix3f, vertexconsumer, -4, 2, 0, 0.0F, 0.15625F, 0, 1, 0, p_113844_);
        }
