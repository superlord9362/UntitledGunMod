...
import superlord.powder_keg.registry.PowderKegDamageSources;
...
public abstract class AbstractBullet extends Projectile {
	...
	protected void onHitEntity(EntityHitResult p_36757_) {
		...
		if (entity1 == null) {
			damagesource = PowderKegDamageSources.bullet(this, this);
		} else {
			damagesource = PowderKegDamageSources.bullet(this, entity1);
